var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		this.tracker = new AR.ClientTracker("assets/bupt.wtc", {
		...
		*/
		var imgOne = new AR.ImageResource("assets/1to building3.png");
		...
		*/
		var pageOneButton = this.createWwwButton("http://www.bupt.edu.cn/", 0.5, {
			offsetX: -0.25,
			offsetY: -0.25,
			zOrder: 1
		});
		...
		*/
		var pageOne = new AR.Trackable2DObject(this.tracker, "1building 3rd", {
			drawables: {
		...
		*/
		var imgTwo = new AR.ImageResource("assets/2to eastern door.png");
		var overlayTwo = new AR.ImageDrawable(imgTwo, 0.5, {
			offsetX: 0.12,
			offsetY: -0.01
		});
		var pageTwoButton = this.createWwwButton("http://www.baidu.com", 0.5, {
			offsetX: 0,
			offsetY: -0.25,
			zOrder: 1
		});
		...
		*/
		var pageTwo = new AR.Trackable2DObject(this.tracker, "2eastern door", {
			drawables: {
	...
	worldLoaded: function worldLoadedFn() {
		...
		var cssDiv2 = " style='display: table-cell;vertical-align: middle; text-align: left; padding-right: 15px;'";
		document.getElementById('loadingMessage').innerHTML =
			"<div" + cssDivInstructions + ">Scan Target &#35;1  or &#35;2 :</div>" +
			"<div" + cssDiv1 + "><img src='assets/1building 3rd-min.png'></img></div>" +
			"<div" + cssDiv2 + "><img src='assets/2eastern door-min.png'></img></div>";
